...
public final class StacktraceDeobfuscator {
    ...
    public static void init(File mappings) {
        ...
        if (!mappings.exists()) {
            ...
            try {
                // updated to maven.minecraftforge as mcpbot link is dead.
                URL mappingsURL = new URL("https://maven.minecraftforge.net/de/oceanlabs/mcp/mcp_stable/39-1.12/mcp_stable-39-1.12.zip");
                connection = (HttpsURLConnection) mappingsURL.openConnection();
