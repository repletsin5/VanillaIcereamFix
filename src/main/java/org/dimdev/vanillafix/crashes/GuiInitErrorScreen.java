...
public class GuiInitErrorScreen extends GuiProblemScreen {
    ...
    public void initGui() {
        ...
        GuiButton b = new GuiButton(1, width / 2 - 155,  height / 4 + 120 + 12, 310, 20, I18n.format("vanillafix.gui.disabled"));
        b.enabled=false;
        buttonList.add(b);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) { // TODO: localize number of lines
        ...
        drawString(fontRenderer, I18n.format("vanillafix.initerrorscreen.paragraph3.line1_5"), x, y += 12, textColor);
