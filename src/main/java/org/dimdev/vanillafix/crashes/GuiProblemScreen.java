...
public abstract class GuiProblemScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        GuiButton b = new GuiButton(1, width / 2 - 155 + 160,  height / 4 + 120 + 12, 150, 20, I18n.format("vanillafix.gui.disabled"));
        b.enabled=false;
        buttonList.add(b);
    }
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.id == 1) {
            ...
            */
            button.displayString = I18n.format("vanillafix.gui.disabled");
            button.enabled = false;
        }
    }
